...
import { loadMessagesFromServer, stopAllMessageStreams, stopMessageStreamForChat, startMessageStreamForChat } from './chat-messages.js';
...
export async function checkChatExists(chatId) {
    try {
        ...
        console.log(`🔍 Чат ${chatId} ${exists ? 'существует' : 'не существует'}`);
        return exists;
    } catch (error) {
